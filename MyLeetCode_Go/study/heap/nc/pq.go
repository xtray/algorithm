...
//// *********************** 优先队列实现
//
//// PriorityQueue holds elements in an array-list
...
//func (pq PriorityQueue) Less(i, j int) bool { return pq.Comparator(pq.list[i], pq.list[j]) > 0 }
//func (pq PriorityQueue) Swap(i, j int)      { pq.list[i], pq.list[j] = pq.list[j], pq.list[i] }
//
...
//}
//
//func NewHeapWith(comparator Comparator) *PriorityQueue {
//	var list []*Node
//	return &PriorityQueue{ list: list , Comparator: comparator}
//}
//
...
////}
//
//func NewListNode(values ...interface{}) *Node {
//	list := &Node{}
//	if len(values) > 0 {
//		list.Add(values...)
//	}
