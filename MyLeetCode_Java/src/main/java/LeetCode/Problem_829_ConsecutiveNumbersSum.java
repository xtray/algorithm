...
public class Problem_829_ConsecutiveNumbersSum {
    ...
    // (2x+k−1)×k=2n : x, k均为正整数, 得知 k为2n较小的约数
    // 我们可以在 [1, √2n) 范围内枚举 k，如果 k 为 2n 约数，并且结合(2x+k−1)×k=2n可验证a合法，
