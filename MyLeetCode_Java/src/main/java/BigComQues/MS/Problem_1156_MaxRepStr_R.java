...
public class Problem_1156_MaxRepStr_R {
    ...
    public static void main(String[] args) {
        ...
        var ans = new Problem_1156_MaxRepStr_R().maxRepOpt1(text);
        System.out.println(ans);
        var res = new Problem_1156_MaxRepStr_R().maxRepOpt2(text);
        ...
        for (int i = 0; i < times; i++) {
            ...
            var ans1 = new Problem_1156_MaxRepStr_R().maxRepOpt1(str);
            var ans2 = new Problem_1156_MaxRepStr_R().maxRepOpt2(str);
            if (ans1 != ans2) {
