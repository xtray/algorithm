...
public class Problem_582_WordBreakII {
    ...
    public static void main(String[] args) {
        String s = "lintcode";
        String[] dict = {"de", "ding", "co", "code", "lint"};
        Set<String> set = new HashSet<>(List.of(dict));
        var ans = new Problem_582_WordBreakII().wordBreak(s, set);
