...
public class Problem_JZ44_NthDigit_2 {
    ...
    public static void main(String[] args) {
        ...
        int n = 1000000000; //1
        var ans = new Problem_JZ44_NthDigit_2().findNthDigit(n);
        System.out.println(ans);

        var ans1 = new Problem_JZ44_NthDigit_2().findNthDigit1(n);
        System.out.println(ans1);

        var ans2 = new Problem_JZ44_NthDigit_2().findNthDigit2(n);
